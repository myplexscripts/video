...
/* Homepage design layer
   Goal: desktop should have its own editorial layout, not a scaled mobile view.
...
(function(){
  ...
  style.textContent=`
    ...
    body.home-redesign #content:not(.dp-wrap) .hero-actions{gap:16px!important;align-items:center!important}
    ...
    body.home-redesign #content:not(.dp-wrap)> .home-top-cw .hub-carousel{
      position:relative!important;
      height:calc(100dvh - var(--pill-clear) - 112px)!important;
    ...
    body.home-redesign #content:not(.dp-wrap)> .home-top-cw .hub-cs-slide{
      ...
      grid-template-columns:minmax(360px,50%) minmax(360px,1fr)!important;
    ...
    body.home-redesign #content:not(.dp-wrap)> .home-top-cw .home-feature-art::after{
      content:"";position:absolute;inset:0;pointer-events:none;background:linear-gradient(to right,transparent 68%,#050505 100%)!important;
    }
    body.home-redesign #content:not(.dp-wrap)> .home-top-cw .hero-top{
      ...
      transform:translateX(clamp(-144px,-7vw,-72px))!important;
    }
    body.home-redesign #content:not(.dp-wrap)> .home-top-cw h2,
    body.home-redesign #content:not(.dp-wrap)> .home-top-cw .hume-text-title{
      font-size:clamp(86px,8.4vw,172px)!important;
      max-width:min(54vw,980px)!important;
    }
    ...
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .hub-cs-slide{
      ...
      display:grid!important;
      grid-template-columns:minmax(320px,46%) minmax(340px,1fr)!important;
    ...
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .home-feature-art{
      grid-column:1!important;width:100%!important;max-width:520px!important;aspect-ratio:1/1!important;position:relative!important;overflow:hidden!important;background:#141416!important;border:1px solid rgba(255,255,255,.10)!important;
    }
    ...
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .hero-top{grid-column:2!important;padding:0!important;text-align:left!important;transform:translateX(clamp(-112px,-6vw,-48px))!important}
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) h2,
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .hume-text-title{font-size:clamp(72px,7vw,142px)!important;max-width:min(56vw,900px)!important}
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .hero-bottom{grid-column:2!important;padding:0!important;margin-top:18px!important;transform:translateX(clamp(-112px,-6vw,-48px))!important}
    ...
    body.home-redesign #content:not(.dp-wrap) .bill-title{grid-row:2!important;font-family:var(--font-head,var(--font))!important;font-size:26px!important;font-weight:800!important;line-height:1.04!important;letter-spacing:-.03em!important;color:var(--text)!important;margin:16px 0 0!important;min-height:2.08em!important;white-space:normal!important;display:-webkit-box!important;-webkit-line-clamp:2!important;-webkit-box-orient:vertical!important;overflow:hidden!important}
