...
/* Homepage design layer
   Desktop has its own centered editorial carousel layout.
   Continue Watching becomes the top hero carousel, carousel-style hubs use the
   same square-art + big-text composition, and normal rails keep aligned card
   slots. */
(function(){
  const HOME_LIMIT=10;
  ...
  style.textContent=`
    :root{--hume-title-shadow:drop-shadow(0 12px 22px rgba(5,5,5,.88)) drop-shadow(0 3px 7px rgba(5,5,5,.78))}
    .dp-title{filter:var(--hume-title-shadow)!important;text-shadow:none!important}
    ...
    body.home-redesign #content:not(.dp-wrap) .title-line+.title-line{margin-top:-.05em!important}
    ...
    body.home-redesign #content:not(.dp-wrap) .hero-actions{gap:16px!important;align-items:center!important;justify-content:center!important}
    ...
    body.home-redesign #content:not(.dp-wrap)> .home-top-cw .hub-carousel{
      position:relative!important;
      width:min(1220px,calc(100vw - (var(--edge) * 2)))!important;
    ...
    body.home-redesign #content:not(.dp-wrap)> .home-top-cw .hub-cs-slide{
      ...
      grid-template-columns:minmax(280px,390px) minmax(0,760px)!important;
      gap:0!important;
    ...
    body.home-redesign #content:not(.dp-wrap)> .home-top-cw .hero-top{
      ...
      transform:translateX(clamp(-72px,-4vw,-36px))!important;
    ...
    body.home-redesign #content:not(.dp-wrap)> .home-top-cw .hume-text-title{
      font-size:clamp(76px,6.2vw,132px)!important;
      line-height:.9!important;
      max-width:100%!important;
    }
    body.home-redesign #content:not(.dp-wrap)> .home-top-cw .hero-top::after{margin-left:auto!important;margin-right:auto!important;width:min(300px,46vw)!important}
    ...
    /* User-selectable carousel style: same language as top hero, scaled for a rail. */
    ...
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .hub-carousel{
      position:relative!important;
      width:min(1120px,calc(100vw - (var(--edge) * 2)))!important;
    ...
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .hub-cs-slide{
      ...
      display:grid!important;
      grid-template-columns:minmax(260px,340px) minmax(0,660px)!important;
      gap:0!important;
      place-content:center!important;
      align-items:center!important;
      justify-items:start!important;
    ...
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .home-feature-art{grid-column:1!important;justify-self:end!important;width:clamp(280px,22vw,340px)!important;max-width:none!important;aspect-ratio:1/1!important;position:relative!important;overflow:hidden!important;background:#141416!important;border:0!important}
    ...
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .hero-top{grid-column:2!important;width:min(640px,54vw)!important;padding:0!important;text-align:left!important;transform:translateX(clamp(-64px,-4vw,-32px))!important;justify-self:start!important}
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) h2,
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .hume-text-title{font-size:clamp(68px,5.6vw,120px)!important;line-height:.9!important;max-width:100%!important}
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .hero-top::after{margin-left:auto!important;margin-right:auto!important;width:min(280px,42vw)!important}
    body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .hero-bottom{grid-column:2!important;width:min(640px,54vw)!important;padding:0!important;margin-top:16px!important;transform:translateX(clamp(-64px,-4vw,-32px))!important;justify-self:start!important}
    ...
    @media(max-width:680px){
      ...
      body.home-redesign #content:not(.dp-wrap)> .home-top-cw .hub-carousel{height:calc(100dvh - var(--tab-h,64px) - 48px)!important;min-height:620px!important;margin:0!important;width:100%!important}
      ...
      body.home-redesign #content:not(.dp-wrap)> .home-top-cw h2,
      body.home-redesign #content:not(.dp-wrap)> .home-top-cw .hume-text-title{font-size:clamp(50px,14vw,86px)!important;line-height:.9!important;max-width:calc(100vw - 24px)!important;margin:0 auto!important}
      ...
      body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .hub-carousel{height:620px!important;margin:0!important;width:100%!important}
      ...
      body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) h2,
      body.home-redesign #content:not(.dp-wrap)> .hub-carousel-section:not(.home-top-cw) .hume-text-title{font-size:clamp(46px,13vw,80px)!important;line-height:.9!important;max-width:calc(100vw - 24px)!important;margin:0 auto!important}
      ...
      body.home-redesign #content:not(.dp-wrap) .rail-head h3,
      body.home-redesign #content:not(.dp-wrap) .editorial-head h2,
      body.home-redesign #content:not(.dp-wrap) .section h3{font-size:clamp(40px,11vw,64px)!important;line-height:.92!important}
  ...
  function patchFactories(){
    ...
    try{
      if(typeof wireHero==="function"&&!wireHero.__humePolished){
        ...
        wireHero=function(wrap,it,opts={}){ const out=originalWireHero(wrap,it,opts); ensureSlideSquareAndText(wrap,it); schedulePolish(); return out; };
    ...
    try{
      if(typeof railSection==="function"&&!railSection.__humePolished){
        ...
        railSection=function(title,items=[],wide,featured,_libLabel,seeAll,actorThumb,summary,collId,numbered){
          const all=Array.isArray(items)?items:[]; const info=splitRailTitle(title);
          const sec=originalRailSection(info.title,all.slice(0,HOME_LIMIT),wide,featured,"",false,actorThumb,summary,collId,numbered);
          finishSection(sec,title,all.length); makeSeeAll(sec,title,all,wide,"",summary,collId); return sec;
        };
    ...
    try{
      if(typeof squareBoardRailSection==="function"&&!squareBoardRailSection.__humePolished){
        ...
        squareBoardRailSection=function(title,items=[],_libLabel,numbered,summary){
          ...
          finishSection(sec,title,all.length); makeSeeAll(sec,title,all,false,"",summary,""); return sec;
        };
    ...
    try{
      if(typeof carouselHubSection==="function"&&!carouselHubSection.__humePolished){
        ...
        carouselHubSection=function(hub){
          const all=hub.items||[]; const info=splitRailTitle(hub.title);
          const sec=originalCarouselHubSection({...hub,title:info.title,lib:"",items:all.slice(0,HOME_LIMIT)});
          finishSection(sec,hub.title,all.length); makeSeeAll(sec,hub.title,all,true,"",hub.summary,"");
    ...
    try{
      if(typeof editorialSection==="function"&&!editorialSection.__humePolished){
        ...
        editorialSection=function(title,items=[],_libLabel){
          ...
          finishSection(sec,title,all.length); makeSeeAll(sec,title,all,false,"","",""); return sec;
        };
